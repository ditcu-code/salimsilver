...
export default function SilverPriceLoading() {
  return (
    <div className="space-y-6">
      {/* Mock Toggle - Visual only */}
      <div className="flex items-center justify-center space-x-2 opacity-50">
        <Switch id="ppn-mode-skeleton" disabled />
        <Label htmlFor="ppn-mode-skeleton">Termasuk PPN 11%</Label>
      </div>
