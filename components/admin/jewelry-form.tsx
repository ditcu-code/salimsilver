    ...
    <div className="space-y-8 max-w-2xl">
      <form onSubmit={onSubmit} className="space-y-6">
        ...
        <div className="grid gap-4 md:grid-cols-3">
            ...
            <div className="space-y-2">
                ...
                <Input id="material_purity" name="material_purity" defaultValue={initialData?.material_purity} placeholder="e.g. 925" />
            </div>
            <div className="space-y-2">
                <Label htmlFor="weight_grams">Weight (g)</Label>
                <Input id="weight_grams" name="weight_grams" type="number" step="0.1" defaultValue={initialData?.weight_grams} />
            </div>
        </div>
      ...
      {isEditing && (
          <div className="space-y-4 pt-8 border-t">
              ...
              <ImageUpload 
                jewelryId={initialData.id} 
                images={initialData.jewelry_images || []} 
              />
          </div>
      )}
    </div>
