    ...
    if (props !== null && props !== void 0 && props.autoHeight) {
      ...
      options.height =
        (_ref$current = ref.current) === null || _ref$current === void 0
          ? void 0
          : (_ref$current$parentNo = _ref$current.parentNode) === null ||
              _ref$current$parentNo === void 0
            ? void 0
  ...
  React.useEffect(function () {
    ...
    script(twitterWidgetJs, "twitter-embed", function () {
      ...
      if (isComponentMounted) {
        ...
        window.twttr.widgets[methodName$1](
          props.url,
          ref === null || ref === void 0 ? void 0 : ref.current,
          props.options
        ).then(function (element) {
  ...
  React.useEffect(function () {
    ...
    script(twitterWidgetJs, "twitter-embed", function () {
      ...
      if (isComponentMounted) {
        ...
        window.twttr.widgets[methodName$2](
          props.screenName,
          ref === null || ref === void 0 ? void 0 : ref.current,
          props.options
        ).then(function (element) {
  ...
  React.useEffect(function () {
    ...
    script(twitterWidgetJs, "twitter-embed", function () {
      ...
      if (isComponentMounted) {
        ...
        window.twttr.widgets[methodName$3](
          props.tag,
          ref === null || ref === void 0 ? void 0 : ref.current,
          props.options
        ).then(function (element) {
  ...
  React.useEffect(function () {
    ...
    script(twitterWidgetJs, "twitter-embed", function () {
      ...
      if (isComponentMounted) {
        ...
        window.twttr.widgets[methodName$4](
          props.screenName,
          ref === null || ref === void 0 ? void 0 : ref.current,
          props.options
        ).then(function (element) {
  ...
  React.useEffect(function () {
    ...
    script(twitterWidgetJs, "twitter-embed", function () {
      ...
      if (isComponentMounted) {
        ...
        window.twttr.widgets[methodName$6](
          props.momentId,
          ref === null || ref === void 0 ? void 0 : ref.current,
          props.options
        ).then(function (element) {
  ...
  React.useEffect(function () {
    ...
    script(twitterWidgetJs, "twitter-embed", function () {
      ...
      if (isComponentMounted) {
        ...
        window.twttr.widgets[methodName$7](
          props.id,
          ref === null || ref === void 0 ? void 0 : ref.current,
          props.options
        ).then(function (element) {
  ...
  React.useEffect(function () {
    ...
    script(twitterWidgetJs, "twitter-embed", function () {
      ...
      if (isComponentMounted) {
        ...
        window.twttr.widgets[methodName$8](
          props.id,
          ref === null || ref === void 0 ? void 0 : ref.current
        ).then(function (element) {
          setLoading(false)
  ...
  React.useEffect(function () {
    ...
    script(twitterWidgetJs, "twitter-embed", function () {
      ...
      if (isComponentMounted) {
        ...
        window.twttr.widgets[methodName$9](
          props.username,
          ref === null || ref === void 0 ? void 0 : ref.current,
          props.options
        ).then(function (element) {
